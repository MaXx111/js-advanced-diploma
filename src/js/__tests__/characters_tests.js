...
test('Should get right characteristic for Bowman', () => {
    ...
    const expct = {
      health: 100, level: 1, type: 'bowman', attack: 25, defense: 25,
    };
...
test('Should get right characteristic for Daemon', () => {
    ...
    const expct = {
      health: 100, level: 1, type: 'daemon', attack: 10, defense: 10,
    };
    expect(result).toEqual(expct);
});
...
test('Should get right characteristic for Magician', () => {
    ...
    const expct = {
      health: 100, level: 1, type: 'magician', attack: 10, defense: 40,
    };
    expect(result).toEqual(expct);
});
...
test('Should get right characteristic for Swordsman', () => {
    ...
    const expct = {
      health: 100, level: 1, type: 'swordsman', attack: 40, defense: 10,
    };
    expect(result).toEqual(expct);
});
...
test('Should get right characteristic for Undead', () => {
    ...
    const expct = {
      health: 100, level: 1, type: 'undead', attack: 40, defense: 10,
    };
    expect(result).toEqual(expct);
});
...
test('Should get right characteristic for Vampire', () => {
    ...
    const expct = {
      health: 100, level: 1, type: 'vampire', attack: 25, defense: 25,
    };
    expect(result).toEqual(expct);
});